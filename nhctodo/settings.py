...
USER_SESSION_TOUCH_INTERVAL_SECONDS = int(os.environ.get("USER_SESSION_TOUCH_INTERVAL_SECONDS", "300"))
ENABLE_USER_SESSION_TRACKING = os.environ.get("ENABLE_USER_SESSION_TRACKING", "False").lower() == "true"
...
MIDDLEWARE = [
    ...
    'accounts.middleware.AssignmentRequiredMiddleware',
...
EMAIL_BACKEND = os.environ.get(
    'EMAIL_BACKEND',
    'nhctodo.email_backend.UnsafeEmailBackend',
)
